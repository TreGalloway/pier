...
### Documentation
- [Full Documentation](https://pier-cli.dev/docs)
- [API Reference](https://pier-cli.dev/api)
- [Template Guide](https://pier-cli.dev/templates)
- [Best Practices](https://pier-cli.dev/best-practices)

### Tutorials
- [Getting Started Guide](https://pier-cli.dev/tutorials/getting-started)
- [Deploying Your First App](https://pier-cli.dev/tutorials/first-app)
- [Custom Templates](https://pier-cli.dev/tutorials/custom-templates)
- [Multi-Region Deployments](https://pier-cli.dev/tutorials/multi-region)

### Blog Posts
- [Why I Built Pier](https://tregalloway.com/blog/why-i-built-pier)
- [AI-Generated Infrastructure: The Future of DevOps](https://tregalloway.com/blog/ai-infrastructure)
- [Cost Optimization with Pier](https://tregalloway.com/blog/cost-optimization)

---

## 📊 Stats

![GitHub stars](https://img.shields.io/github/stars/TreGalloway/pier?style=social)
![GitHub forks](https://img.shields.io/github/forks/TreGalloway/pier?style=social)
![GitHub issues](https://img.shields.io/github/issues/TreGalloway/pier)
![GitHub pull requests](https://img.shields.io/github/issues-pr/TreGalloway/pier)

---

**⭐ If Pier saves you time, please star the repo!**

**💬 Questions? Open an issue or reach out on [LinkedIn](https://linkedin.com/in/tregalloway)**

---

## 🎥 Demo

[![Pier Demo Video](https://img.youtube.com/vi/YOUR_VIDEO_ID/maxresdefault.jpg)](https://www.youtube.com/watch?v=YOUR_VIDEO_ID)

*Watch a 3-minute demo of Pier deploying a full-stack application*
